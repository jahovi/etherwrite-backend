 ...
 * names to the list in subscribers.ts in order to be instatiated 
 * at startup. 
 */
export default abstract class CS_Subscriber {

	/**
	 * This object provides access to the non
	 * private methods and properties of the 
	 * ChangesetProcessor instance. 
	 * 
	...
	constructor(padName:string){
		...
		if(!this.dataSource)
			logService.error(CS_Subscriber.name,"failed to connect to CSP for "+padName);
